...
impl IconName {
    ...
    pub fn render(self) -> Element {
        match self {
            ...
            IconName::Wrench => rsx! {
                svg { xmlns: "http://www.w3.org/2000/svg", class: "icon", view_box: "0 0 24 24", fill: "none", stroke: "currentColor", stroke_width: "1.5",
                    path { d: "M21.75 6.75a4.5 4.5 0 0 1-4.884 4.484c-1.076-.091-2.264.071-3.026.474a.75.75 0 0 0-.457.783c.067.717.006 1.44-.184 2.137l-.626 2.348a.75.75 0 0 1-.727.553H8.25a.75.75 0 0 1-.727-.553L6.897 14.618a3.75 3.75 0 0 1 3.063-4.688l1.544-.309a2.25 2.25 0 0 0 1.88-2.224v-.565a4.5 4.5 0 0 0-1.324-3.183A4.5 4.5 0 0 0 9.75 3h-.75a4.5 4.5 0 0 0-4.5 4.5v.75a.75.75 0 0 0 .75.75h.75a.75.75 0 0 0 .75-.75v-.75a3 3 0 0 1 3-3h.75a3 3 0 0 1 3 3v.565c0 .995-.496 1.92-1.324 2.475l-1.544.309a5.25 5.25 0 0 0-4.288 6.563l.626 2.348a2.25 2.25 0 0 0 2.181 1.658h4.494a2.25 2.25 0 0 0 2.181-1.658l.626-2.348a5.25 5.25 0 0 0-4.288-6.563l-1.544-.309a3.75 3.75 0 0 1-3.063 4.688l-.626 2.348a.75.75 0 0 1-.727.553h-.75a.75.75 0 0 1-.727-.553l-.626-2.348a5.25 5.25 0 0 0 4.288-6.563l1.544.309A3.75 3.75 0 0 1 12 6.434" }
                }
            },
