use dioxus::prelude::*;
use workshop_common::dto::RepairPartResponse;
use workshop_common::{Product, RepairStatus};
...
pub fn PartsTab(
    ...
    rsx! {
        div { class: "detail-section mt-md",
            ...
            if is_closed {
                p { class: "text-muted mt-md", "Reparación finalizada — no se pueden agregar ni eliminar insumos" }
            } else {
